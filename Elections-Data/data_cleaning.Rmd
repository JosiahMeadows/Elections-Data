...
fl_jan <- read_xlsx("raw_data /fl_counties.xlsx",
                    skip = 3,
                    sheet = 2) %>%
  clean_names() %>%
  rename(republican = "republican_party_of_florida") %>%
...
fl_feb <- read_xlsx("raw_data /fl_counties.xlsx", 
                    skip = 3,
                    sheet = 3) %>% 
  clean_names() %>%
  rename(republican = "republican_party_of_florida") %>%
...
fl_mar <- read_xlsx("raw_data /fl_counties.xlsx", 
                    skip = 3,
                    sheet = 4) %>% 
  clean_names() %>%
  rename(republican = "republican_party_of_florida") %>%
...
fl_apr <- read_xlsx("raw_data /fl_counties.xlsx", 
                    skip = 3,
                    sheet = 5) %>% 
  clean_names() %>%
  rename(republican = "republican_party_of_florida") %>%
...
fl_may <- read_xlsx("raw_data /fl_counties.xlsx", 
                    skip = 3,
                    sheet = 6) %>% 
  clean_names() %>%
  rename(republican = "republican_party_of_florida") %>%
...
fl_jun <- read_xlsx("raw_data /fl_counties.xlsx", 
                    skip = 3, 
                    sheet = 7) %>% 
  clean_names() %>%
  rename(republican = "republican_party_of_florida") %>%
...
fl_jul <- read_xlsx("raw_data /fl_counties.xlsx", 
                    skip = 3,
                    sheet = 8) %>% 
  clean_names() %>%
  rename(republican = "republican_party_of_florida") %>%
...
fl_aug <- read_xlsx("raw_data /fl_counties.xlsx", 
                    skip = 3,
                    sheet = 9) %>% 
  clean_names() %>%
  rename(republican = "republican_party_of_florida") %>%
...
fl_dec <- read_xlsx("raw_data /fl_counties.xlsx",
                        skip = 3) %>% 
  clean_names() %>%
